...
# TLS_CERT_PATH               -> PEM cert for TLS/QUIC listeners (Aspire dev cert)
# TLS_KEY_PATH                -> PEM key for TLS/QUIC listeners (Aspire dev cert)
...
[ -z "$OTEL_INSTANCE_ID" ] && echo "WARNING: OTEL_INSTANCE_ID is unset" >&2
...
[ -z "$TLS_CERT_PATH" ] && echo "WARNING: TLS_CERT_PATH is unset" >&2
[ -z "$TLS_KEY_PATH" ] && echo "WARNING: TLS_KEY_PATH is unset" >&2
